...
public class Homepage extends ActionBarActivity implements
    ...
    public final static String EXTRA_URL = "com.aptdemo.yzhao.androiddemo.URL";

    public final static String EXTRA_LOGIN_STATUS = "com.aptdemo.yzhao.androiddemo.LOGIN_STATUS";
...
//          mRevokeButton.setVisibility(View.VISIBLE);
        ...
        loginStatus = "True," + email;

//        Intent intent= new Intent(this, DisplayStreams.class);
//
//        String allStreamsUrl = "TemporaryUrlForU!";
//        intent.putExtra(EXTRA_URL, allStreamsUrl);
...
//        mRevokeButton.setVisibility(View.INVISIBLE);
    ...
    public void viewAllStreams(View view){
        ...
        String allStreamsUrl = "TemporaryUrlForU!";
        intent.putExtra(EXTRA_URL, allStreamsUrl);
        intent.putExtra(EXTRA_LOGIN_STATUS,loginStatus);
        startActivity(intent);
    }
