...
public class ViewNearbyStreams extends FragmentActivity implements
    ...
    public void onConnected(Bundle dataBundle) {
        ...
        final String request_url = "http://testp3-1106.appspot.com/ViewNearbyStreams/"+indexes+"/"+location+"/";

        Log.d("urlNrby",request_url);

        final Button more_nearby_photos = (Button)findViewById(R.id.more_nearby_photos);

        RequestHandle requestHandle = httpClient.get(request_url, new AsyncHttpResponseHandler() {
            @Override
            public void onSuccess(int statusCode, Header[] headers, byte[] response) {
                ...
                try {
                    ...
                    for (int i = 0; i < allPhotos.length(); i++) {
                        ...
                        String photoServingURL = jObject2.getString("photoURL");
                    ...
                    gridview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView parent, View v,
                                                int position, long id) {
                            Intent intent = new Intent(ViewNearbyStreams.this, ViewSingleStream.class);
