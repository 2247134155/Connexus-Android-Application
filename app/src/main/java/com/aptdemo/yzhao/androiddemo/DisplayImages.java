...
public class DisplayImages extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String request_url = "http://testp3-1106.appspot.com/dumpImageUrls/abbue/";
        ...
        httpClient.get(request_url, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] response) {
                ...
                try {
                    ...
                    JSONArray displayImages = jObject.getJSONArray("imageUrls");
                    JSONArray displayCaption = jObject.getJSONArray("imageUrls");
